...
async function onRequest({ request, env }) {
  ...
  const stream = response.pipeThrough(new TextDecoderStream()).pipeThrough(new SSEToStream()).pipeThrough(new TextEncoderStream());
...
// ../.wrangler/tmp/pages-R18b2e/functionsRoutes-0.22874456170182933.mjs
var routes = [
  {
    routePath: "/src/api/generate",
    mountPath: "/src/api",
    method: "",
    middlewares: [],
    modules: [onRequest]
